...
function filterStudentsByGrade(students, grade) {
	...
	console.error("Критична помилка! Завдання 1 виконано не правильно!");
	console.clear();
	console.log("Завдання: 1 ==============================");
...
function compareArrays(arr1, arr2) {
	...
	if (!Array.isArray(arr1) || !Array.isArray(arr2)) {
		console.error("Аргументи мають бути масивами!");
		return null;
	} else {
		arr1.sort((a, b) => a - b);
		arr2.sort((a, b) => a - b);
...
function traceBackward(n) {
	...
	if (n > 1) {
		...
		console.log(traceBackward);
	} // не знаю як вивести стек викликів
...
function countVowelsAndConsonants(word) {
	...
	} console.count(`Кількість голосних: ${vowelsCount}, кількість приголосних: ${consonantsCount}`);
	console.countReset("countVowelsAndConsonants");
}
